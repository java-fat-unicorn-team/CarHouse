...
public class CommentDaoImpl implements CommentDao {
     ...
     *
     * @param comment the comment
     * @return true if comment was updated and false if there is not such comment in database
     */
    @Override
     ...
     * @return true if comment was deleted and false if there is not such comment in database
     */
    @Override
